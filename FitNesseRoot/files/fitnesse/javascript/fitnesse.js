...
/** FitLibrary 2.0 compability */
function toggleCollapsable(id) { $('#' + id).toggle().parent('.included').toggleClass('open'); }
function expandAll() { $('.included').each(function(i, e) { if (!$(e).hasClass('open')) { toggleCollapsable($(e).children().last().attr('id')) } }); }
function collapseAll() { $('.included').each(function(i, e) { if ($(e).hasClass('open')) { toggleCollapsable($(e).children().last().attr('id')) } }); }
